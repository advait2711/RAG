        ...
        <nav className="border-b border-brand-500/10 bg-surface-950/80 backdrop-blur-xl sticky top-0 z-50">
            <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
                ...
                >
                    ...
                    <span className="text-lg font-bold gradient-text">RAG Visualizer</span>
                </div>

                <button
                    onClick={handleReset}
                    className="flex items-center gap-2 text-sm text-surface-200/70 hover:text-brand-400 transition-colors"
                >
                    <RotateCcw size={14} />
                    Start Over
                </button>
